...
export default class SectionNineAccordion extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      this.props.text4 &&
      prevProps.text4 &&
      this.props.text4.visibleModal !== prevProps.text4.visibleModal
    ) {
      this.setState({
        ...
        >
          <div className="accordion_title" onClick={this.toggle}>
            <div className="arrow_up">
              <img
                className="arrow"
                src={this.state.isVisible ? up : down}
                alt={this.state.isVisible ? up : down}
              />
            </div>
          ...
          <div
            className={
              this.state.isVisible
                ? "accordion_body activeBody"
                : "accordion_body inactive"
            }
          >
