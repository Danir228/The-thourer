      ...
      <>
        <div className="section-10_item">
          <div className="section-10_item-1">
            <h1 className="section-10_title">
              {t("thethourer.main.section10.title1.child1")}{" "}
              <span className="section-10_title_item">
                {t("thethourer.main.section10.title1.child2")}
              </span>
            </h1>
            <h2 className="section-10_subtitle">
              {t("thethourer.main.section10.title2")}
            </h2>
