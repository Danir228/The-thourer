  ...
  render() {
    ...
    return (
      <>
        <Row>
          <Col>
            <h1 className="section-3_title">
              {t("thethourer.main.section3.title.start")}{" "}
              <span className="textupdate">
                {t("thethourer.main.section3.title.center")}
              </span>{" "}
              {t("thethourer.main.section3.title.end")}
            </h1>
          </Col>
        </Row>
        <Row className="section-3_item-1 mx-0">
          <Col className="mb-3">
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part1.child1"
              )}<span class="textupdate"> ${t(
                "thethourer.main.section3.part1.child2"
              )}</span>`}
            />
          </Col>
          <Col className="mb-3">
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part2.child1"
              )}<span class="textupdate"> ${t(
                "thethourer.main.section3.part2.child2"
              )}</span> ${t("thethourer.main.section3.part2.child3")}`}
            />
          </Col>
          <Col className="mb-3 marginblock">
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part3.child1"
              )}<span class="textupdate"> ${t(
                "thethourer.main.section3.part3.child2"
              )}</span> ${t(
                "thethourer.main.section3.part3.child3"
              )} <span class='textupdate'>${t(
                "thethourer.main.section3.part3.child4"
              )}</span>`}
            />
          </Col>
          <Col className="mb-3">
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part4.child1"
              )}<span class="textupdate"> ${t(
                "thethourer.main.section3.part4.child2"
              )}</span> ${t("thethourer.main.section3.part4.child3")}`}
            />
          </Col>
          <Col>
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part5.child1"
              )}<span class='textupdate'> ${t(
                "thethourer.main.section3.part5.child2"
              )}</span> ${t("thethourer.main.section3.part5.child3")}`}
            />
          </Col>
          <Col className="marginblock">
            <SectionBlock
              ...
              text={`${t(
                "thethourer.main.section3.part6.child1"
              )}<span class='textupdate'> ${t(
                "thethourer.main.section3.part6.child2"
              )}</span> ${t(
                "thethourer.main.section3.part6.child3"
              )} <span class='textupdate'>${t(
                "thethourer.main.section3.part6.child4"
              )}</span> ${t("thethourer.main.section3.part6.child5")}`}
            />
          </Col>
        </Row>
      </>
