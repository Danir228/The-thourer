          ...
          <Col
            className={
              this.props.i18n.language === "en"
                ? "section-6_title titleEn"
                : "section-6_title"
            }
          >
            <h1 className="section-6_title_item-1">
              {t("thethourer.main.section6.title.child1")}
            </h1>
            <h2 className="section-6_title_item-2">
              {t("thethourer.main.section6.title.child2")}
            </h2>
          </Col>
        </Row>
        <Row>
            ...
            items={[
              <div className="section-6_price_item">
                <PriceItem
                  ...
                  text1={{
                    start: "",
                    center: " 1 ",
                    end: `${t("thethourer.main.section6.part1.child3")}`,
                  }}
                  text2={{
                    start: "2",
                    end: ` ${t("thethourer.main.section6.part1.child4")}`,
                  }}
                  text3={{
                    start: "4",
                    end: ` ${t("thethourer.main.section6.part1.child5")}`,
                  }}
              ...
              <div className="section-6_price_item">
                <PriceItem
                  ...
                  text1={{
                    start: `${t("thethourer.main.section6.part2.child3")}`,
                    center: " 3 ",
                    end: `${t("thethourer.main.section6.part2.child4")}`,
                  }}
                  text2={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part2.child5")}`,
                  }}
                  text3={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part2.child6")}`,
                  }}
              ...
              <div className="section-6_price_item">
                <PriceItem
                  ...
                  text1={{
                    start: `${t("thethourer.main.section6.part3.child3")}`,
                    center: " 15 ",
                    end: `${t("thethourer.main.section6.part3.child4")}`,
                  }}
                  text2={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part3.child5")}`,
                  }}
                  text3={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part3.child6")}`,
                  }}
              ...
              <div className="section-6_price_item">
                <PriceItem
                  ...
                  text1={{
                    start: `${t("thethourer.main.section6.part4.child3")}`,
                    center: " 50 ",
                    end: `${t("thethourer.main.section6.part4.child4")}`,
                  }}
                  text2={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part4.child5")}`,
                  }}
                  text3={{
                    start: "∞",
                    end: ` ${t("thethourer.main.section6.part4.child6")}`,
                  }}
