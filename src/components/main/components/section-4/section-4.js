      ...
      <>
        <Row>
          <Col className="section-4_title">
            <h1 className="section-4_title_item-1">
              {t("thethourer.main.section4.title1.start")}{" "}
              <span className="textupdate">
                {t("thethourer.main.section4.title1.end")}
              </span>
            </h1>
            <h2 className="section-4_title_item-2">
              <span className="textupdate">
                {t("thethourer.main.section4.title2.start")}
              </span>{" "}
              {t("thethourer.main.section4.title2.end")}
            </h2>
          </Col>
        </Row>
          ...
          <Col className="section-4_image">
            ...
            {this.state.first && (
              <img
                src={gif1}
                alt={"...loading"}
                className="section-4_image-gifs"
              ></img>
            )}
            {this.state.second && (
              <img
        ...
        <Row className="section-4_bottom_item mx-0">
          <Col className="section-4_bottom_item_body d-flex justify-content-between px-0 py-0">
            <p className="bottom_text">
              {t("thethourer.main.section4.title3.start")}{" "}
              <span className="bottom_text_item">
                {t("thethourer.main.section4.title3.end")}
              </span>
            </p>
            <AppStoreButton
              onEnter={enter}
